...
global mu iephem ephname km ip1 ip2 revmax opps
...
legend([h1(1), h2(1)], 'C3L (km^2/sec^2)', 'arrival v_\infty (km/sec)', 'Northwest');
...
legend([h1(1), h2(1)], 'DLA (deg)', 'C3L (km^2/sec^2)', 'Northwest');
...
legend([h1(1), h2(1)], 'RLA (deg)', 'C3L (km^2/sec^2)', 'Northwest');
...
legend([h1(1), h2(1)], 'TOF (days)', 'C3L (km^2/sec^2)', 'Northwest');
...
legend([h1(1), h2(1)], 'v-infinity (km/sec)', 'DLA (degrees)', 'Northwest');
...
legend([h1(1), h2(1)], 'v-infinity (km/sec)', 'RLA (degrees)', 'Northwest');
...
legend([h1(1), h2(1)], 'TOF (days)', 'DVT (km/sec)', 'Northwest');
